...
// Make a GET request to the SWAPI endpoint to fetch movie data
request.get(apiUrl, (error, response, body) => {
  ...
  if (response.statusCode === 200) {
    ...
    // Fetch and display character names in the correct order
    fetchAndDisplayCharacterNames(characters);
  } else {
...
function fetchAndDisplayCharacterNames(characterUrls) {
